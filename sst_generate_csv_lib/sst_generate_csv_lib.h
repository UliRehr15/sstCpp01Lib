...
//==============================================================================
/**
* @brief // Write CSV Type classes to header and class file <BR>
...
* @param DsVerw   [in] DsVerw
* @param sSysNam  [in] sSysNam
* @param sDateStr [in] sDateStr
*
* @return Errorstate
*
* @retval   = 0: OK
...
//==============================================================================
/**
* @brief // Write CSV Function classes to header and class file
